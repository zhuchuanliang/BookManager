...
public class BookTypeManageInterFrm extends JInternalFrame {
				...
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							...
							.addGap(1)
							.addComponent(bookTypeDescTxt, GroupLayout.DEFAULT_SIZE, 388, Short.MAX_VALUE))
						.addGroup(gl_panel.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(bookTypeNameTxt, GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE)))
					.addContainerGap())
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(105)
	...
	protected void bookTypeUpdateActionEvent(ActionEvent evt) {
		...
		if(StringUtil.isEmpty(bookTypeName)){
			JOptionPane.showMessageDialog(null, "图书类别的名称不能为空");
			return;
		}
